-- Licenciatura en Ciencias de Datos - Univ. Austral
-- Prácticas Pre Parcial de Bases de Datos 
-- db Mateando
...
INSERT INTO PRODUCTOS VALUES (
    ...
    (SELECT codigo from TiposProductos WHERE descripcion="Bombillas"),  # atrib. descripcion es de tipo UNIQUE
    (SELECT codigo from Materiales WHERE material="Acero")  # atrib. material es de tipo UNIQUE
);
